...
class AddingSection extends Component {
    render () {
        ...
        if (onTop) { return <Button onClick={() => dispatch(toggleFormAddSectionToTop())}>+ Add section</Button>; } else { return <Button onClick={() => dispatch(toggleFormAddSection())}>+ Add section</Button>; }
    }
}
